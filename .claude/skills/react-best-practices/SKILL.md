...
- `.claude/skills/react-best-practices/references/react-performance-guidelines.md` - Complete guide with all patterns
- `.claude/skills/react-best-practices/references/rules/` - Individual rule files organized by category

To look up a specific pattern, grep the rules directory:
```
grep -rl "suspense" .claude/skills/react-best-practices/references/rules/
grep -rl "barrel" .claude/skills/react-best-practices/references/rules/
grep -rl "swr" .claude/skills/react-best-practices/references/rules/
```

## Rule Categories in `.claude/skills/react-best-practices/references/rules/`
...
[vercel-labs/agent-skills](https://github.com/vercel-labs/agent-skills/tree/react-best-practices/skills/react-best-practices),
ветка `react-best-practices`, забрано 2026-09-01. Содержимое правил без изменений;
в SKILL.md пути к `references/` приведены к путям от корня репозитория.
