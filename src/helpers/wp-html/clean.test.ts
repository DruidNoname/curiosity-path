...
/**
 * Тесты публичного входа: санитизация плюс полный конвейер целиком.
 * Поведение отдельных шагов проверяется в transforms/*.test.ts,
 * порядок и устройство конвейера — в pipeline.test.ts.
 */
